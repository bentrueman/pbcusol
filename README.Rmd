...
Metal binding to natural organic matter can be modeled using `pb_sol_wham()`, an approximation of the Windermere Humic Acid Model (WHAM) (Tipping and Hurley, 1992), as described in Example 19 of Parkhurst and Appelo (2013).
